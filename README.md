...
|:--|:--|:--|
| Кликер | **Автокликер** | Три независимых канала — атака (ЛКМ), использование (ПКМ), прыжок. Режимы «Клик» и «Удержание», интервал, время удержания, случайная задержка, ожидание перезарядки оружия, выбор целей (существа / + блоки / всё), лимиты по атакам и времени, задержка старта, работа в фоне |
...
| | **Авто-тотем** | Держит тотем бессмертия во второй руке (всегда или ниже порога здоровья) |
